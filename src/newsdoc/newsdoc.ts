...
class Document$Type extends MessageType<Document> {
    constructor() {
        super("newsdoc.Document", [
            ...
            { no: 6, name: "content", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
            { no: 7, name: "meta", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
            { no: 8, name: "links", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
...
class Block$Type extends MessageType<Block> {
    constructor() {
        super("newsdoc.Block", [
            ...
            { no: 13, name: "links", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
            { no: 14, name: "content", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
            { no: 15, name: "meta", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Block },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for newsdoc.Block.data");
            }
        }
        map[key ?? ""] = val ?? "";
    }
