...
/**
 * @generated from protobuf message ttab.baboon.GetRenderedArticlesResponse
 */
export interface GetRenderedArticlesResponse {
    /**
     * @generated from protobuf field: repeated ttab.baboon.RenderEvent events = 1
     */
    events: RenderEvent[];
}
/**
 * @generated from protobuf message ttab.baboon.RenderEvent
 */
...
export interface CopyArticleToFlowRequest {
     ...
     *
     * @generated from protobuf field: int64 source_version = 5
     */
...
class ListHypenationsResponse$Type extends MessageType<ListHypenationsResponse> {
    constructor() {
        super("ttab.baboon.ListHypenationsResponse", [
            { no: 1, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Hypenation }
        ]);
    }
...
class GetRenderedArticlesRequest$Type extends MessageType<GetRenderedArticlesRequest> {
    ...
    create(value?: PartialMessage<GetRenderedArticlesRequest>): GetRenderedArticlesRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.after = 0n;
        if (value !== undefined)
            reflectionMergePartial<GetRenderedArticlesRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetRenderedArticlesRequest): GetRenderedArticlesRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: GetRenderedArticlesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 after = 1; */
        if (message.after !== 0n)
...
/**
 * @generated MessageType for protobuf message ttab.baboon.GetRenderedArticlesRequest
 */
export const GetRenderedArticlesRequest = new GetRenderedArticlesRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetRenderedArticlesResponse$Type extends MessageType<GetRenderedArticlesResponse> {
    constructor() {
        super("ttab.baboon.GetRenderedArticlesResponse", [
            { no: 1, name: "events", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RenderEvent }
        ]);
    }
    create(value?: PartialMessage<GetRenderedArticlesResponse>): GetRenderedArticlesResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.events = [];
        if (value !== undefined)
            reflectionMergePartial<GetRenderedArticlesResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetRenderedArticlesResponse): GetRenderedArticlesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ttab.baboon.RenderEvent events */ 1:
                    message.events.push(RenderEvent.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetRenderedArticlesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ttab.baboon.RenderEvent events = 1; */
        for (let i = 0; i < message.events.length; i++)
            RenderEvent.internalBinaryWrite(message.events[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message ttab.baboon.GetRenderedArticlesResponse
 */
export const GetRenderedArticlesResponse = new GetRenderedArticlesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RenderEvent$Type extends MessageType<RenderEvent> {
    constructor() {
        super("ttab.baboon.RenderEvent", [
            ...
            { no: 5, name: "rendered", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RenderedArticle },
            { no: 6, name: "removed", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RenderedArticle },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RenderEvent): RenderEvent {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RenderEvent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int64 id = 1; */
        if (message.id !== 0n)
...
/**
 * @generated MessageType for protobuf message ttab.baboon.RenderEvent
 */
export const RenderEvent = new RenderEvent$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RenderedArticle$Type extends MessageType<RenderedArticle> {
    constructor() {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RenderedArticle): RenderedArticle {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RenderedArticle, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string date = 1; */
        if (message.date !== "")
...
/**
 * @generated MessageType for protobuf message ttab.baboon.RenderedArticle
 */
...
class CreateFlowResponse$Type extends MessageType<CreateFlowResponse> {
    constructor() {
        super("ttab.baboon.CreateFlowResponse", [
            { no: 1, name: "articles", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PrintArticleReference }
        ]);
    }
...
class CopyArticleToFlowRequest$Type extends MessageType<CopyArticleToFlowRequest> {
    constructor() {
        super("ttab.baboon.CopyArticleToFlowRequest", [
            ...
            { no: 5, name: "source_version", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string article */ 4:
                    message.article = reader.string();
                    break;
                case /* int64 source_version */ 5:
                    message.sourceVersion = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CopyArticleToFlowRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sourceVersion !== 0n)
            writer.tag(5, WireType.Varint).int64(message.sourceVersion);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class GetScribusInfoResponse$Type extends MessageType<GetScribusInfoResponse> {
    constructor() {
        super("ttab.baboon.GetScribusInfoResponse", [
            { no: 1, name: "fonts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ScribusDependency },
            { no: 2, name: "icc_profiles", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ScribusDependency },
            { no: 3, name: "slots", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "layers", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ScribusLayer }
        ]);
    }
...
class ScribusLayer$Type extends MessageType<ScribusLayer> {
    constructor() {
        super("ttab.baboon.ScribusLayer", [
            ...
            { no: 4, name: "frames", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ScribusFrame }
        ]);
    }
...
class GetFontsRequest$Type extends MessageType<GetFontsRequest> {
    constructor() {
        super("ttab.baboon.GetFontsRequest", [
            { no: 1, name: "fonts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => FontRef }
        ]);
    }
...
class GetFontsResponse$Type extends MessageType<GetFontsResponse> {
    constructor() {
        super("ttab.baboon.GetFontsResponse", [
            { no: 1, name: "fonts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Font }
        ]);
    }
...
class ListFontsResponse$Type extends MessageType<ListFontsResponse> {
    constructor() {
        super("ttab.baboon.ListFontsResponse", [
            { no: 1, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => FontInfo },
...
class ListICCProfilesResponse$Type extends MessageType<ListICCProfilesResponse> {
    constructor() {
        super("ttab.baboon.ListICCProfilesResponse", [
            { no: 1, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ICCProfileInfo },
            { no: 2, name: "next_page", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class RenderArticleResponse$Type extends MessageType<RenderArticleResponse> {
    constructor() {
        super("ttab.baboon.RenderArticleResponse", [
            ...
            { no: 7, name: "images", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MountedImage },
            { no: 8, name: "overflows", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Overflow },
            { no: 9, name: "tagged_text_url", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "underflows", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Underflow }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.bool();
                    break;
                default: throw new globalThis.Error("unknown map entry field for ttab.baboon.LayoutPreviewRequest.features");
            }
        }
        map[key ?? ""] = val ?? false;
    }
...
class LayoutPreviewResponse$Type extends MessageType<LayoutPreviewResponse> {
    constructor() {
        super("ttab.baboon.LayoutPreviewResponse", [
            ...
            { no: 2, name: "images", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MountedImage },
            { no: 3, name: "overflows", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Overflow },
            { no: 4, name: "scribus_doc", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 5, name: "underflows", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Underflow }
        ]);
    }
